...
/**
 * Displays trust badges for the marketplace to build buyer confidence
 * 
 * @param {Object} props
 * @param {string} props.type - "marketplace" for the overall marketplace page or "project" for individual projects
 * @param {Object} props.project - Optional project data when displaying on a specific project
 */
const TrustBadges = ({ type, project }) => {
  return (
    <div className={`trust-badges ${type === 'marketplace' ? 'marketplace-badges' : 'project-badges'}`}>
